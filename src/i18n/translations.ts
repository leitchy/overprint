...
const en = {
  ...
  exportAllCoursesPdf: 'Export All Courses PDF',
...
const fr: Partial<Record<TranslationKey, string>> = {
  ...
  exportAllCoursesPdf: 'Exporter tous les circuits PDF',
...
const de: Partial<Record<TranslationKey, string>> = {
  ...
  exportAllCoursesPdf: 'Alle Bahnen als PDF exportieren',
...
const es: Partial<Record<TranslationKey, string>> = {
  ...
  exportAllCoursesPdf: 'Exportar todos los recorridos PDF',
...
const fi: Partial<Record<TranslationKey, string>> = {
  ...
  exportAllCoursesPdf: 'Vie kaikki radat PDF',
...
const it: Partial<Record<TranslationKey, string>> = {
  ...
  exportAllCoursesPdf: 'Esporta tutti i percorsi PDF',
...
const sv: Partial<Record<TranslationKey, string>> = {
  ...
  exportAllCoursesPdf: 'Exportera alla banor PDF',
...
const ja: Partial<Record<TranslationKey, string>> = {
  ...
  exportAllCoursesPdf: '全コースPDF書き出し',
